...
# setUpClass (see odoo-development-ui-test skill,
# structure-and-runner.md §Base class).
from odoo.tests import HttpSavepointCase, tagged


@tagged("post_install", "-at_install")
class TestUiDataImportOperatingUnit(HttpSavepointCase):
    ...
    def setUpClass(cls):
        ...
        operating_unit_partner = cls.env["res.partner"].create(
            {"name": "Tour Data Import OU Partner"}
        )
        cls.operating_unit = cls.env["operating.unit"].create(
            {
                "name": "Tour Data Import Operating Unit",
                "code": "TDIOU",
    ...
    def test_create(self):
        ...
        IK: docs/data_import/01-create.md (E1 delta -- Additional
        Fields)
        """
        self.start_tour(
            "/web",
