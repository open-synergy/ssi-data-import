...
# pylint: disable=C8101
{
    ...
    "data": [
        ...
        "security/ir_model_access/edit_data_import_row.xml",
        "security/ir_model_access/ignore_data_import_row.xml",
        "security/ir_model_access/ignore_data_import_error.xml",
        ...
        "views/assets.xml",
        "wizards/edit_data_import_row.xml",
        "wizards/ignore_data_import_row.xml",
        "wizards/ignore_data_import_error.xml",
    ],
    "demo": [],
